...
export function computeStats(rows: ParsedRow[], currency: string, provider: string, log: string[], errors: number): RUPEStats {
  let totalNet = 0, totalGross = 0, totalTaxes = 0, totalCosts = 0, totalStreams = 0
